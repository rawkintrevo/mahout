...
class CochraneOrcutt extends Regressor {
  ...
  var regressor : Regressor = null // type of regression to do- must have a 'beta' fit param
  ...
  /**
    * Updates the beta to account for autocorrelation
    * https://en.wikipedia.org/wiki/Cochrane%E2%80%93Orcutt_estimation
    * @param drmX
    * @tparam Int
    */
  //def fitWithY[Int](drmY: DrmLike[Int], drmX: DrmLike[Int])= {
